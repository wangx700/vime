...
MEGATRON_ADAPTOR_ROOT="${MEGATRON_ADAPTOR_ROOT:-/home/vllm/c00944022/vime-proj/MegatronAdaptor}"
TRANSFORMER_ENGINE_NPU_ROOT="${TRANSFORMER_ENGINE_NPU_ROOT:-/home/vllm/c00944022/vime-proj/TransformerEngineNPU}"
